          ...
          <section className={classes.caseStudyContainer}>
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  ...
                  were spending 5-10 minutes per student clicking through
                  multiple data panels just to answer basic questions like "How
                  is this student doing overall?
                </p>
                <p className={classes.description}>
                  <span className={classes.bold}>My solution: </span>
                  Designed a student overview panel that synthesizes key
                  insights from across main intervention areas, including
                  attendance patterns, academic progress, graduation
                  requirements, and intervention data—in one scannable view.
                </p>
                <p className={classes.description}>
                  <span className={classes.bold}>The impact: </span>150%
                  increase in student profile page views, and 40% increase in
                  daily active users on this page, and 28% growth in monthly
                  active users.
                </p>
                <p className={classes.description}>
                  <span className={classes.bold}>Key innovation: </span>Created
                  a skeleton loading system that became a reusable pattern
                  adopted across 5 other Portal features, solving performance
                  constraints while enhancing user experience.
                </p>
                <p className={classes.title} style={{ marginTop: 32 }}>
                  My role
                </p>
                <p className={classes.description}>
                  Lead Product Designer working directly with engineering,
                  product management, and 8 NYC educators. I owned the
                  end-to-end design process from research through implementation
                  over 3 months.
                </p>
              </section>
            ...
            >
              <section>
                ...
                <img
                  ...
                  onClick={() => {
                    trackClick('image', 'Scroll to learn more arrow', 'Student Profile Case Study');
                    trackCaseStudyInteraction('Student Profile', 'click', 'scroll_arrow');
                  }}
                />
              </section>
            </section>
            ...
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(3) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  ...
                  selection of data points on Mixpanel data and stakeholder
                  requests. After faciliating a design review with key
                  stakeholders, I received feedback that this approach was
                  comprehensive but unfocused.
                </p>
              </section>
              <div className={classes.caseStudyImageContainer}>
                <Zoom classDialog={classes.zoomBackground}>
                  <img src={wireframe} width="100%" alt="Initial wireframe showing comprehensive dashboard with 6+ modules for student data overview" />
                </Zoom>
              </div>
            </section>
            <div
            ...
            <section
              className={clsx(
                ...
                classes.ohTwoStyles,
                classes.animatedSection,
                animatedSections.has(4) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  I facilitated alignment workshops with product managers across
                  5 different teams and as a team, we established that this
                  panel should "tell the student's educational journey" and
                  provide "actionable information" for next steps. This became
                  my design criteria.
                </p>
                <p className={classes.description}>
                  The collaborative breakthrough was establishing that this
                  panel shows highlights for quick student risk assessment, with
                  each module clickable to access their team's detailed
                  information in dedicated panels. This approach honored
                  everyone's needs while serving our users.
                </p>
              </section>
              <div className={classes.caseStudyImageContainer}>
                {" "}
                ...
                >
                  <img
                    src={brainStorm}
                    width="100%"
                    alt="Brainstorming session template showing collaborative alignment workshop with product teams"
            ...
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(5) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  With this foundation, I could redesign with clear purpose.
                  After extensive stakeholder conversations across multiple
                  teams, we landed on 4 core modules that balanced immediate
                  insight with actionable context: current month attendance,
                  current GPA, credits earned, and regents fulfilled.
                </p>
                <p className={classes.description}>
                  Each module follows the same pattern with the primary metric
                  at top and a contextual change indicator below, because users
                  needed both "where the student stands now" and "which
                  direction they're trending."
                </p>
                <p className={classes.description}>
                  The month-over-month and marking period comparisons came from
                  user research showing that static numbers felt meaningless
                  without context. The graduation tracking statuses addressed
                  counselor workflows around intervention timing. This structure
                  gives educators the snapshot they need while showing whether
                  each area requires immediate attention.
                </p>
              </section>
              <div className={classes.caseStudyImageContainer}>
                <Zoom classDialog={classes.zoomBackground}>
                  <img src={drawingBoard} width="100%" alt="Drawing board showing redesigned 4-module student overview panel with attendance, GPA, credits, and regents tracking" />
                </Zoom>
              </div>
            </section>
            <img src={width >= 551 ? dots : line} className={classes.dots} alt="Decorative dots or line separator" />
            ...
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(6) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  ...
                  additional data visualizations, inspired by the visual
                  elements I'd successfully introduced elsewhere in the panel, I
                  used this validation data to advocate for strategic focus.
                </p>
                <p className={classes.description}>
                  The compromise was adding progress bars to the respective
                  detailed panels where there's room to explain their
                  complexity, while keeping the overview modules simple.
                </p>
                <p className={classes.description}>
                  We also replaced the attendance graph with an interactive
                  attendance calendar, addressing their preference for more
                  visual data representation while maintaining core simplicity,
                  since user research showed school staff needed to quickly
                  identify attendance patterns that could inform intervention
                  decisions.
                </p>
              </section>
              <div className={classes.caseStudyImageContainer}>
                <Zoom classDialog={classes.zoomBackground}>
                  <img src={validation} width="100%" alt="Validation testing results showing stakeholder feedback on progress bars and data visualizations" />
                </Zoom>
                <p
                  className={classes.caption}
                  style={{ marginBottom: width <= 1200 ? 32 : 48 }}
                >
                  Some stakeholders pushed for progress bars in the top 4
                  modules
                </p>
                <Zoom classDialog={classes.zoomBackground}>
                  <img src={refinement} width="100%" alt="Refined design showing compromise solution with progress bars moved to detailed panels instead of overview modules" />
                </Zoom>
                <p
                  className={classes.caption}
            ...
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(7) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  Engineering flagged a critical issue: the new overview panel
                  required loading data from 4 different backend systems
                  simultaneously (8+ API calls) versus existing on-demand
                  loading. On school Chromebooks, this meant 5+ second load
                  times that would lose users entirely.
                </p>
                <p className={classes.description}>
                  I proposed skeleton loading for the entire overview panel.
                  Users see the full structure with animated placeholders while
                  data loads. I created design documentation defining skeleton
                  states for different content types, establishing shared
                  language between teams.
                </p>
                <p className={classes.description}>
                  The solution was so effective that these skeleton loading
                  components now serve 5 different Portal features and
                  established design patterns for new features across the
                  platform
                </p>
              </section>
              {width >= 551 && (
                <video
                  ...
                  onPlay={() => trackVideoInteraction('Skeleton Loading Demo', 'play')}
                  onPause={() => trackVideoInteraction('Skeleton Loading Demo', 'pause')}
                  onEnded={() => trackVideoInteraction('Skeleton Loading Demo', 'complete')}
                >
              ...
              {width <= 550 && (
                <img
                  width="100%"
                  src={skeletonGif}
                  alt="Animated GIF showing skeleton loading system with animated placeholders while data loads"
                  style={{ border: "0.5px solid #e4e4e7", borderRadius: 8 }}
                />
              )}
            </section>
            ...
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(8) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  Two new data visualizations were introduced as a apart of this
                  work. One is the interactive calendar widget, which shows
                  daily attendance patterns because visual patterns reveal
                  insights that percentages hide.
                </p>
                <p className={classes.description}>
                  Teachers can instantly identify concerning patterns—like every
                  Monday absence suggesting weekend issues, or absences
                  clustered around test dates. This helps them distinguish
                  between students needing family support versus academic
                  intervention.
                </p>
              </section>
              {width >= 551 && (
                <video
                  ...
                  className={clsx(
                    classes.customVideo,
                    classes.studentProfileVideo
                  )}
                  controlsList="nodownload noplaybackrate noremoteplayback"
                  disablePictureInPicture
                  onPlay={() => trackVideoInteraction('Attendance Calendar Demo', 'play')}
                  onPause={() => trackVideoInteraction('Attendance Calendar Demo', 'pause')}
                  onEnded={() => trackVideoInteraction('Attendance Calendar Demo', 'complete')}
                >
              ...
              {width <= 550 && (
                <img
                  width="100%"
                  src={attendanceGif}
                  alt="Animated GIF showing interactive attendance calendar widget with visual patterns for identifying attendance trends"
                  style={{ border: "0.5px solid #e4e4e7", borderRadius: 8 }}
                />
              )}
            </section>
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(10) ? "animate" : ""
              )}
            ...
            >
              ...
              {width >= 551 && (
                <video
                  ...
                  controlsList="nodownload noplaybackrate noremoteplayback"
                  disablePictureInPicture
                  onPlay={() => trackVideoInteraction('Academics Module Demo', 'play')}
                  onPause={() => trackVideoInteraction('Academics Module Demo', 'pause')}
                  onEnded={() => trackVideoInteraction('Academics Module Demo', 'complete')}
                >
              ...
              {width <= 550 && (
                <img
                  width="100%"
                  src={academicsGif}
                  alt="Animated GIF showing academics module with traffic light color system for course performance tracking"
                  style={{ border: "0.5px solid #e4e4e7", borderRadius: 8 }}
                />
              )}
            </section>
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(11) ? "animate" : ""
              )}
            ...
            >
              <section className={classes.caseStudyInfo}>
                <p
                  ...
                  style={{ marginTop: width <= 1200 && 0 }}
                >
                  The final design consolidates the four most critical data
                  points teachers need: attendance patterns, academic
                  performance, graduation progress, and state testing
            ...
            <section
              className={clsx(
                ...
                classes.ohTwoStyles,
                classes.animatedSection,
                animatedSections.has(12) ? "animate" : ""
              )}
                ...
                <div className={classes.impactContent}>
                  ...
                  >
                    <p
                      style={{
                        fontFamily:
                          "Roobert_Latin_Regular, Verdana, sans-serif",
                        fontSize: 14,
                    ...
                    <div className={classes.resultsContainer}>
                      <p className={classes.results}>
                        <span className={classes.resultsPercentage}>
                          {currentNumbers.views}%
                        </span>
                        Increase in student profile page views
                      </p>
                      <p className={classes.results}>
                        <span className={classes.resultsPercentage}>
                          {currentNumbers.dailyUsers}%
                        </span>
                        Increase in daily active users on this page
                      </p>
                      <p className={classes.results}>
                        <span className={classes.resultsPercentage}>
                          {currentNumbers.monthlyUsers}%
                        </span>
                    ...
                    >
                      ...
                      <li>
                        Established the design language for how we present
                        complex educational data platform-wide
                      </li>
                      <li>
            ...
            <section
              className={clsx(
                ...
                classes.ohOneStyles,
                classes.animatedSection,
                animatedSections.has(13) ? "animate" : ""
              )}
            ...
            >
              ...
              >
                ...
                <p className={classes.description}>
                  ...
                  <br />
                  Getting 5 product teams to agree on design criteria took just
                  as much effort as the actual design work. I learned that
                  framing decisions around shared goals ("tell the student's
                  educational journey") worked better than trying to convince
                  teams my approach was right.
                </p>
                <p className={classes.description}>
                  <span className={classes.bold}>
                ...
                <p className={classes.description}>
                  ...
                  problem became a reusable pattern adopted by 5 other teams.
                  This taught me that addressing immediate constraints
                  thoughtfully can drive platform-wide improvements.
                </p>
              </section>{" "}
            </section>
            <div className={classes.nextProjectContainer}>
              <p className={classes.nextProjectHeader}>Next Project</p>
              <p className={classes.nextProjectTitle}>
              ...
              <Link to="/dataGrid" className={classes.nextProjectLink}>
                <div className={classes.nextProjectCircleButton}>
                  <img
                    ...
                    onClick={() => {
                      trackClick('button', 'Next Project Arrow', 'Student Profile Case Study');
                      trackCaseStudyInteraction('Student Profile', 'click', 'next_project_button');
                    }}
                  />
                </div>
              </Link>
