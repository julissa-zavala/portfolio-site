...
const DataGrid = () => {
  ...
  const images = [
    {
      original: templateView,
    },
    {
      original: customView,
    },
    {
      original: defaultView,
    },
  ];
        ...
        <section className="container">
          ...
          <section className={classes.caseStudyContainer}>
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  ...
                  defeating the platform's core value of live, updated data
                  across 900+ columns.
                </p>
                <p className={classes.description}>
                  <span className={classes.bold}>My solution: </span>
                  Designed a hybrid view system with role-based templates plus
                  custom saved views, featuring intuitive save/manage controls
                  and sidebar organization.
                </p>
                <p className={classes.description}>
                  <span className={classes.bold}>The impact: </span>Support
                  tickets about session timeouts dropped 80% (from ~15 to 2-3
                  weekly), feature abandonment dropped from 60% to 20%, and
                  users returned to working with fresh daily data instead of
                  static exports.
                </p>
                ...
                <p className={classes.description}>
                  Lead Product Designer responsible for user research,
                  stakeholder alignment, and design strategy.
                </p>
              </section>
            ...
            >
              <section className={classes.caseStudyInfo}>
                <p className={classes.title}>
                  <span className={classes.number}>01</span>The great
                  spreadsheet migration
                </p>
                <p className={classes.description}>
                  Our student profile data grid served 10,000+ NYC educators
                  daily, but it was driving them away. Users faced all 927
                  columns at once, creating an overwhelming interface. New users
                  would abandon it immediately, while experienced users rebuilt
                  their entire setup every morning after session timeouts or
                  school switches.
                </p>
                <p className={classes.description}>
              ...
              <div className={classes.caseStudyImageContainer}>
                <Zoom classDialog={classes.zoomBackground}>
                  <img
                    src={beforeImageSVG}
                    width="100%"
                    alt="Before: Data grid interface showing overwhelming 927 columns with no organization or filtering options"
            ...
            >
              <section className={classes.caseStudyInfo}>
                <p className={classes.title}>
                  <span className={classes.number}>02</span>From Symptoms to
                  Root Cause
                </p>
                <p className={classes.description}>
                  Initial support data showed a high volume of session timeout
                  complaints where users would configure their grid, navigate
                  away to other tasks, then return to find their work lost. This
                  led us to assume users simply needed save functionality.
                </p>
                <p className={classes.description}>
                  Through 8 interviews with principals, counselors, and
                  teachers, I discovered that session timeouts were just the
                  final straw in a much larger workflow problem.
                </p>
                <ol
              ...
              <div className={classes.quoteContainer}>
                <p className={classes.quote}>
                  “I&#8217;d spend 20 minutes setting up my grid, leave to help
                  a student, then come back to find the system logged me out and
                  all my work gone. Now I just export to Sheets instead.”
                </p>
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                <p className={classes.description}>
                  This made me realize we needed to shift. Instead of just
                  adding the ability to save, how might we give users
                  role-appropriate starting points while maintaining
                  flexibility?
                </p>
                <p className={classes.description}>
                  Our MongoDB architecture limited how much view data we could
                  efficiently store, but this constraint led to a better
                  solution. After multiple meetings with engineering, product
                  managers, and school liaisons (where various teams initially
                  wanted their own specialized templates), we established 5 core
                  templates covering essential use cases.
                </p>
              </section>
              <div className={classes.caseStudyImageContainer}>
                {" "}
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      display: "flex",
                      justifyContent: width >= 976 ? "space-between" : "center",
                      width: "100%",
                      marginBottom: width >= 976 && 64,
                    }}
                  >
                    {" "}
                    {width <= 976 && (
            ...
            >
              <section className={classes.caseStudyInfo}>
                <p className={classes.title}>
                  <span className={classes.number}>04</span>Core interface
                  design
                </p>
                <p className={classes.description}>
                  The interface centered on an intuitive split-button save
                  control. 'Save Changes' was prominently displayed with 'Save
                  As New' accessible via dropdown, plus quick view switching via
                  sidebar. We also added a save prompt that appeared whenever
                  users navigated away from the grid, preventing work loss
                  during session timeouts.
                </p>
                <p className={classes.description}>
                  To accommodate new controls without overwhelming the
                  interface, I restructured the page into two stacked menu bars:
                  grid-related actions in the top bar, student-related actions
                  in the bottom bar.
                </p>
                <p className={classes.description}>
              ...
              {width <= 550 && (
                <img
                  width="100%"
                  src={gif}
                  alt="Animated GIF showing the save button functionality with split-button design for saving changes"
                  style={{ border: "0.5px solid #e4e4e7", borderRadius: 8 }}
                />
              )}
            </section>
            ...
            >
              <section className={classes.caseStudyInfo}>
                ...
                >
                  ...
                  <li>
                    Feature abandonment rate dropped from 60% to 20% as
                    educators stopped avoiding the grid
                  </li>
                  <li>
                ...
                <p className={classes.description}>
                  Follow-up interviews confirmed users appreciated accessing
                  fresh data daily without setup burden, restoring our
                  competitive advantage. Users also requested view sharing with
                  colleagues—a feature we had identified during initial research
                  but decided to prioritize for a future release.
                </p>
              </section>
              <div className={classes.quoteContainer}>
                <p className={classes.quote}>
                  “Before, I&#8217;d spend the first half hour of my day
                  rebuilding my graduation tracking view. Now I just switch to
                  my saved view and I'm immediately seeing which students need
                  interventions.”
                </p>
                <p className={classes.caption}>
            ...
            >
              <section className={classes.caseStudyInfo}>
                <p className={classes.description}>
                  ...
                  <br />
                  What seemed like a simple "save button" request became a
                  complete workflow redesign once I understood how different
                  roles used the data grid. Eight user interviews uncovered that
                  the real problem wasn't saving configurations. It was starting
                  with role-appropriate ones. This taught me to dig deeper into
                ...
                <p className={classes.description}>
                  ...
                  <br />
                  MongoDB's storage limitations forced us to choose 5 focused
                  templates over dozens of specialized ones. Rather than
                  fighting these constraints, I used them to create a cleaner,
                  faster experience that served users better than unlimited
                  flexibility would have. Sometimes the best solutions come from
                ...
                <p className={classes.description}>
                  ...
                  template requests took extensive negotiation and user data
                  analysis. I learned that focusing on core use cases
                  (attendance tracking, GPA trends) and showing how constraints
                  benefit the user experience was more effective than trying to
                  accommodate every stakeholder request.
                </p>
              </section>{" "}
              {width >= 551 && (
                <video
              ...
              {width <= 550 && (
                <img
                  width="100%"
                  src={gif2}
                  alt="Animated GIF showing the sidebar functionality for managing and switching between saved views"
                  style={{ border: "0.5px solid #e4e4e7", borderRadius: 8 }}
                />
              )}
            </section>
            ...
            >
              ...
              >
                ...
                <p className={classes.description}>
                  I would have tested the two-bar layout concept with users
                  before implementation. While the two-bar solution worked well
                  and solved our space constraints, getting user feedback on the
                  grid vs. student action separation earlier could have
                  validated this approach and potentially revealed other layout
